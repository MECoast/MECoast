******************************************************************************
Pack of 4 V2 Based at New England (Peterborough) 

3D Model built from drawings and textured by Dave Robinson
Sounds By Chris Jephcott File ID:27204
Cabview By hans nooyen File ID:22338
Eng file by Dave Robinson
#AI Files by Dave Robinson
-----------------------------------------------------------------------------
The 3D models has been built using TrainSim Modeller

This pack contains 4 V2 which were based at New England (Peterborough) 
60803 Brunswick Green
60817 Double Chimney Brunswick Green 
60820 BR Lined Black
60881 Double Chimney BR Lined Black

This pack contains 4 different tenders which can be swaped around on any of the V2s these are:-
Brunswick Green with Early Crest 
Brunswick Green With Late Crest
BR Lined Black with Early Crest 
BR Lined Black With Late Crest

These locos comes with changeable headlamps, simple copy over all the dead lamps first from the dead lamp folder in to the 
main folder and then copy from the live lamps folder the lamps you require on the loco to the main folder. 

To install copy all the files to your trainset folder which can be found here 
