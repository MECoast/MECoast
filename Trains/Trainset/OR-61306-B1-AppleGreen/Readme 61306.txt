BR Class B1 4-6-0 steam locomotive
...
This is a model of a BR Class B1 4-6-0 61306 
In BR Apple Green Livery
...
main folder.
The cabview and sounds are supplied with thanks from Lew Price and Stuart Williamson 

Any suggestions of help or constructive comments welcome.

To install simpley copy the 3 files ( DR_BR_B1_61306,Common.Sound,common.cabs ) to your Trainset folder which can be found here
