...
Eng file by Rick gibbs
-----------------------------------------------------------------------------
The 3D model has been built using TrainSim Modeller

This is a model of Ex-LNER A1 60163 Tornado in BR Brunswick Green 

This is my Forth and final version of Tornado with a few more details added.
My Thanks to Rick Gibbs for a new eng file it now has air and Vac brakes alt eng files can be found in the alt eng folder

This loco comes with changeable headlamps, simple copy over all the dead lamps first from the dead lamp folder in to the 
main folder and then copy from the live lamps folder the lamps you require on the loco to the main folder. 

To install copy DR_BR_A1_60163_BG folder to your trainset which can be found here 
(C:\Program Files\Microsoft Games\Train Simulator\TRAINS\Trainset)
Also this comes with two tenders one with the early crest (DR_BR_A1_60163T_EC) and one with late crest (DR_BR_A1_60163T_LC)
