BR Class B12 4-6-0 steam locomotive

3D Model built from drawings and textured by Dave Robinson
Cab view by Lew Price 
Sounds By Stuart Williamson  
Tested by Ben Harrison

-----------------------------------------------------------------------------
The 3D model has been built using TrainSim Modeller

This is a model of a BR Class B12 4-6-0 61572 
in 1963 style BR Black Livery

This loco comes with changeable headlamps simple copy over all the dead lamps or first from the dead lamp 
folder in to the main folder and then copy from the live lamps folder the lamps you require on the loco to the 
main folder.
The cabview is supplied with thanks from Lew Price and you will requier Stuart Williamson's 2 cylinder sound set from 
Uktrainsim file id ( 2910 ).
I have also left in the spare texture file if you would like to change the rods from panted red to metal it can be found 
in the railtour folder along with an other eng file to remove the headboards.  

Any suggestions of help or constructive comments welcome.

To install simpley copy the 3 files ( DR_BR_B12_61572, common.cabs, Common.Sound ) to your Trainset folder which can be 
found here
