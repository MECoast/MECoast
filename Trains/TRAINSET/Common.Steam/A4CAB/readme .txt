Cab view for LNER A4, Version 1.0

To get it to work in any particular loco modify the eng file cab view entry to read A4.cvf
as below
	...
	CabView ( A4.cvf )           (THIS IS THE LINE TO MODIFY)
	HeadOut (  1.4 3.0 -5.3 )
